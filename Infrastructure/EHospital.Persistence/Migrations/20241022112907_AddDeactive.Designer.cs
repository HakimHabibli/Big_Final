...
namespace EHospital.Persistence.Migrations
{
    ...
    [Migration("20241022112907_AddDeactive")]
    partial class AddDeactive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.Auth.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.Auth.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 22, 11, 29, 5, 999, DateTimeKind.Utc).AddTicks(2744));
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.UserDeactivatedSchedule", b =>
                {
                    b.HasOne("EHospital.Domain.Entities.DoctorSchedules", "DoctorSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("EHospital.Domain.Entities.Auth.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("EHospital.Domain.Entities.Auth.AppUser", null)
                        .WithMany()
